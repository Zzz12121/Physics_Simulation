...
void SettingsScene::Initialize() {
    ...
    //my
    /*AddNewObject(new Engine::Image("stage-select/bar.png", halfW - 60, halfH-53));
    AddNewObject(new Engine::Image("stage-select/end.png", halfW - 65, halfH-55));
    AddNewObject(new Engine::Image("stage-select/slider.png", halfW +28, halfH-65));

    AddNewObject(new Engine::Image("stage-select/bar.png", halfW - 60, halfH+53));
    AddNewObject(new Engine::Image("stage-select/end.png", halfW - 65, halfH+51));
    AddNewObject(new Engine::Image("stage-select/slider.png", halfW +28, halfH+44));*/
    //my
